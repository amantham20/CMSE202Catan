...
class FooPlayer(Player):
  ...
  def __init__(self, color):
        ...
        self.WEIGHTS_BY_ACTION_TYPE = {ActionType.BUILD_CITY: 3655, 
        ActionType.BUILD_SETTLEMENT: 5905, 
        ActionType.BUY_DEVELOPMENT_CARD: 1854, 
        ActionType.BUILD_ROAD: 2669}
...
class PlayerE(Player):
  ...
  def copyData(self):
    return self.WEIGHTS_BY_ACTION_TYPE.copy()
  
  def setData(self, data):
    self.WEIGHTS_BY_ACTION_TYPE = data.copy()
